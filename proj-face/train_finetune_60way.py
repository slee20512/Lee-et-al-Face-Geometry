...
args.pretrained = True  # start from ImageNet weights, unlike train_from_scratch_60way.py
...
args.filename_prefix = f'{args.arch}_finetune_60way_IDEM_colorbg_seed{args.seed}_'
