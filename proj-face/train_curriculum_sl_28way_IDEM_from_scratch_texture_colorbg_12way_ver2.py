...
# Cross-domain curriculum, supervised branch: init from the TEXTURED 12-way identity
# ver2 backbone (train_from_scratch_texture_colorbg_12way_supervised_ver2.py), continue
# supervised fine-tuning on the GEOMETRY-only 28-way IDEM dataset (vbsle_50k/28way_IDEM,
# no colorbg) -- the supervised analog of
# train_curriculum_simclr_28way_IDEM_from_simclr12way_colorbg.py (SimCLR branch, same
# cross-domain direction). Unlike the 7-way emotion curricula, this target has 28
# classes, not 7, so there's no fixed-class assertion here.
...
args.filename_prefix = f'{args.arch}_curriculum_sl_28way_IDEM_from_scratch_texture_colorbg_12way_ver2_seed{args.seed}_'
