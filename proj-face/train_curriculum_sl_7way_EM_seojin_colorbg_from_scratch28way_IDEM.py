...
# fine-tuning on the 7-way emotion colorbg dataset -- same lineage as
# train_curriculum_sl_28way_IDEM_colorbg_from_scratch28way_IDEM.py but the emotion
# target instead of the identity target, and same lr/epochs as the other 7way_EM_seojin
# curriculum runs for a like-for-like comparison across stage-1 lineages.
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_colorbg_from_scratch28way_IDEM_seed{args.seed}_'
