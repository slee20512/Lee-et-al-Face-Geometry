...
# Stage-1 (supervised branch) of the 12way-identity -> 7way-emotion curriculum: same
# setup as train_from_scratch_60way.py (random-init SGD), but on the 12-way identity
# dataset (vbsle_50k_12way) instead of the 60-way IDEM colorbg dataset -- same dataset
# as the SimCLR stage-1 in train_simclr_12way_scratch.py. Feeds into
# train_curriculum_sl_7way_EM_seojin_from_scratch12way.py as stage 2.
