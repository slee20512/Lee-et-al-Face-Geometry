...
# Curriculum learning, stage 2 (supervised branch), 12-way-identity ver2 lineage:
# same structure as train_curriculum_sl_7way_EM_seojin_from_scratch12way.py, but the
# stage-1 checkpoint here is train_from_scratch_12way_supervised_ver2.py (warmup +
# cosine + Adam + low weight decay), the only from-scratch 12-way identity recipe
# that broke chance level (Acc@1 95.628) rather than staying at ~8.3%.
...
args.stage1_checkpoint = 'resnet50_scratch_vbsle_50k_12way_ver2_seed777_model_best.pth.tar'
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_from_scratch12way_ver2_seed{args.seed}_'
