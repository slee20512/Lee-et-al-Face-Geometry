# Vendored verbatim from https://github.com/mk-minchul/AdaFace/blob/master/net.py
# (MIT license) so load_model.py can build the IR-SE backbone without adding
# AdaFace as a git submodule / pip dependency.
