...
# GEOMETRY-only 7-way emotion dataset (vbsle_50k/7way_EM_seojin, no colorbg) --
# the reverse domain direction from train_curriculum_simclr_7way_EM_seojin_colorbg_from_simclr12way_colorbg.py,
# which keeps backbone and target both textured.
...
args.filename_prefix = f'{args.arch}_curriculum_simclr_7way_EM_seojin_from_simclr12way_colorbg_seed{args.seed}_'
