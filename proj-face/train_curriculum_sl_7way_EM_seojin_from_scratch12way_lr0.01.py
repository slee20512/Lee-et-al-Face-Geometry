...
# lr0.01 lineage: same structure as
# train_curriculum_sl_7way_EM_seojin_from_scratch12way.py, but the stage-1 checkpoint
# here is train_from_scratch_12way_supervised_lr0.01.py (lr=0.01 ablation) instead of
# the lr=0.1 run, which got stuck at chance-level accuracy.
...
args.stage1_checkpoint = 'resnet50_scratch_vbsle_50k_12way_lr0.01_seed777_model_best.pth.tar'
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_from_scratch12way_lr0.01_seed{args.seed}_'
