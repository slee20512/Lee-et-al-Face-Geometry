...
# Stage-1 (self-supervised branch) of the geometry -> texture curriculum: same setup
# as train_simclr_60way.py (random-init SimCLR, NT-Xent), but on the 28-way IDEM
# *geometry* dataset (vbsle_50k/28way_IDEM, no colorbg) instead of the 60-way IDEM
# colorbg texture dataset. Feeds into train_simclr_60way_from_simclr28way.py as stage 2.
...
args.filename_prefix = f'{args.arch}_simclr_28way_IDEM_seed{args.seed}_'
