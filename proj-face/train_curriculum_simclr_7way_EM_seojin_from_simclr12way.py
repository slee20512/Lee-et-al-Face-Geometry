...
# Stage-2 (self-supervised branch) of the 12way-identity -> 7way-emotion curriculum:
# init from the stage-1 12-way-identity SimCLR backbone (train_simclr_12way_scratch.py),
# continue NT-Xent training on seojin's 7-way emotion images. Same structure as
# train_curriculum_simclr_7way_EM_seojin.py (which instead starts from the 60-way-IDEM
# SimCLR backbone) -- this is the from-scratch-on-12way-identity counterpart.
...
args.stage1_checkpoint = 'resnet50_simclr_vbsle_50k_12way_seed777_model_best.pth.tar'
