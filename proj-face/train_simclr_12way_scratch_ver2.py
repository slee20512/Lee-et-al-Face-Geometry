...
# ver2 of train_simclr_12way_scratch.py: same random-init SimCLR setup (Adam, cosine
# decay) on the 12-way identity dataset, but with linear lr warmup added before the
...
args.filename_prefix = f'{args.arch}_simclr_vbsle_50k_12way_ver2_seed{args.seed}_'
