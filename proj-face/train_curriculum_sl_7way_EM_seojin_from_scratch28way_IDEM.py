...
# train_curriculum_sl_7way_EM_seojin_colorbg_from_scratch28way_IDEM.py but without the
# colorbg domain shift, so this one and that one isolate the colorbg-vs-plain target
# effect while holding the stage-1 backbone fixed.
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_from_scratch28way_IDEM_seed{args.seed}_'
