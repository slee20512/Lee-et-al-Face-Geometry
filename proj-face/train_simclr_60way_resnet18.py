...
# ResNet-18 ablation of train_simclr_60way.py: same random-init SimCLR schedule on the
# full 60-way IDEM colorbg dataset, but resnet18 instead of resnet50. Companion to
# train_from_scratch_60way_resnet18.py (the supervised side of the same arch swap).
...
args.filename_prefix = f'{args.arch}_simclr_60way_IDEM_colorbg_seed{args.seed}_'
