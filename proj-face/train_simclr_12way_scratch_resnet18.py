...
# ResNet-18 ablation of train_simclr_12way_scratch.py: same random-init SimCLR setup
# on the 12-way identity dataset, but resnet18 instead of resnet50. Companion to
# train_from_scratch_12way_supervised_resnet18.py (the supervised side of the same
# arch swap). Feeds into
# train_curriculum_simclr_7way_EM_seojin_from_simclr12way_resnet18.py as stage 2.
...
args.filename_prefix = f'{args.arch}_simclr_vbsle_50k_12way_seed{args.seed}_'
