# Vendored verbatim from https://github.com/IrvingMeng/MagFace/blob/main/models/iresnet.py
# (Apache-2.0 license). Structurally identical (same module names -> same
# state_dict keys) to deepinsight/insightface's arcface_torch iresnet.py, so
# this one file backs both the MagFace and ArcFace load_model() entries --
