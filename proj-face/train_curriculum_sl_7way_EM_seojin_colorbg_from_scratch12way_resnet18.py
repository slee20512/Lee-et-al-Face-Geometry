...
# Textured-domain mirror of train_curriculum_sl_7way_EM_seojin_from_scratch12way_resnet18.py:
# same resnet18 12-way-identity backbone (Acc@1 8.418, chance level), but continued
# on the textured 7-way emotion dataset (vbsle_50k_texture_colorbg/7way_EM_seojin_colorbg)
# instead of the geometry-only 7way_EM_seojin. The geometry version of this curriculum
# reached Acc@1 90.779 despite the chance-level backbone; this tests whether the same
# holds in the textured domain.
...
args.stage1_checkpoint = 'resnet18_scratch_vbsle_50k_12way_seed777_model_best.pth.tar'
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_colorbg_from_scratch12way_seed{args.seed}_'
