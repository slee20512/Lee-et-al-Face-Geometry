...
# resnet18 lineage: same structure as
# train_curriculum_sl_7way_EM_seojin_from_scratch12way.py, but both the stage-1
# checkpoint and this stage are resnet18 instead of resnet50 -- the resnet50
# from-scratch attempts (lr=0.1 and lr=0.01) never learned past chance level on the
# 12-way identity dataset.
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_from_scratch12way_seed{args.seed}_'
