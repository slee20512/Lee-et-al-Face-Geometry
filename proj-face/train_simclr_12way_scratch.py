...
# Stage-1 (self-supervised branch) of the 12way-identity -> 7way-emotion curriculum:
# same setup as train_simclr_60way.py (random-init SimCLR, NT-Xent), but on the 12-way
# identity dataset (vbsle_50k_12way) instead of the 60-way IDEM colorbg dataset.
# Feeds into train_curriculum_simclr_7way_EM_seojin_from_simclr12way.py as stage 2.
