...
# Textured-domain mirror of train_from_scratch_12way_supervised_ver2.py: same
# warmup+cosine+Adam+low-weight-decay recipe (the only one that broke chance level
# on the geometry 12-way identity dataset, Acc@1 95.628), but trained on the
# textured 12-way identity dataset (texture_colorbg_12way) instead. Feeds into
...
args.lr = 1e-3  # Adam lr, not an SGD lr
args.epochs = 100
args.warmup_epochs = 5

args.filename_prefix = f'{args.arch}_scratch_texture_colorbg_12way_ver2_seed{args.seed}_'
