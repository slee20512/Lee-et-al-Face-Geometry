...
# Lower-lr ablation of train_curriculum_sl_7way_EM_seojin_colorbg_from_scratch12way_resnet18.py:
# same resnet18 12-way-identity backbone (Acc@1 8.418, chance level) and same
# textured 7-way emotion target, but lr 3e-5 instead of 3e-4 -- a gentler fine-tune
# intended to shift the backbone's weights less during the texture-domain stage 2,
# preserving more of whatever the stage-1 backbone learned rather than letting the
# emotion fine-tune dominate.
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_colorbg_from_scratch12way_lr3e-5_seed{args.seed}_'
