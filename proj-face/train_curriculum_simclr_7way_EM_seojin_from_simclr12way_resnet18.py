...
# ResNet-18 ablation of train_curriculum_simclr_7way_EM_seojin_from_simclr12way.py:
# init from the resnet18 12-way-identity SimCLR backbone
# (train_simclr_12way_scratch_resnet18.py), continue NT-Xent training on the 7-way
# emotion dataset. Both stages share the same SimCLR projector shape, so the stage-1
# checkpoint loads directly here.
...
args.arch = 'resnet18'
args.batch_size = 64  # 2*batch_size augmented views go through the network per step -- 128 OOM'd on an 11GB 2080Ti even with AMP (resnet50); kept unchanged here
args.print_freq = 30
args.num_workers = 8
...
args.stage1_checkpoint = 'resnet18_simclr_vbsle_50k_12way_seed777_model_best.pth.tar'

args.lr = 3e-5
args.epochs = 50

args.data_root = '/mnt/smb/locker/issa-locker/users/Seojin/data/face_data/vbsle_50k/7way_EM_seojin/'
args.filename_prefix = f'{args.arch}_curriculum_simclr_7way_EM_seojin_from_simclr12way_seed{args.seed}_'
