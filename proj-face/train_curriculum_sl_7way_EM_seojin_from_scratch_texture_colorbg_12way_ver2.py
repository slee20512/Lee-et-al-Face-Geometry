...
# supervised fine-tuning on the GEOMETRY-only 7-way emotion dataset (vbsle_50k/7way_EM_seojin,
# no colorbg) -- the supervised analog of
# train_curriculum_simclr_7way_EM_seojin_from_simclr12way_colorbg.py (SimCLR branch,
# same cross-domain direction).
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_from_scratch_texture_colorbg_12way_ver2_seed{args.seed}_'
