...
# Curriculum learning, stage 2 (supervised branch): init from the plain (geometry-only,
# no colorbg) 28-way IDEM from-scratch backbone (train_from_scratch_28way_IDEM.py,
# SL_resnet50_scratch_28way_IDEM_seed777_model_best -- 95.1% top-1), continue supervised
# fine-tuning on the colorbg version of the same 28-way IDEM identity task. Same class
# count as stage 1 (28), so this is a texture/domain shift rather than a label-space
# change, but the fc head is still rebuilt fresh to match the from-scratch curriculum
...
args.stage1_checkpoint = 'resnet50_scratch_28way_IDEM_seed777_model_best.pth.tar'
...
args.filename_prefix = f'{args.arch}_curriculum_sl_28way_IDEM_colorbg_from_scratch28way_IDEM_seed{args.seed}_'
