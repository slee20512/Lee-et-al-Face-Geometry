...
# ver2 of train_simclr_60way.py: same random-init SimCLR setup (Adam, cosine decay)
# on the 60-way IDEM colorbg dataset, but with linear lr warmup added before the
# cosine decay -- the classic fix for random-init training getting stuck early,
# being tried across the board (supervised and SimCLR, 60-way and 12-way) as ver2.
...
args.filename_prefix = f'{args.arch}_simclr_60way_IDEM_colorbg_ver2_seed{args.seed}_'
