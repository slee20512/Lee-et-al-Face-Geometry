...
# Textured-domain mirror of train_curriculum_sl_7way_EM_seojin_from_scratch60way_resnet18.py:
# same resnet18 60-way-IDEM-colorbg backbone (Acc@1 97.024), but continued on the
# textured 7-way emotion dataset (vbsle_50k_texture_colorbg/7way_EM_seojin_colorbg)
# instead of the geometry-only 7way_EM_seojin -- keeps the backbone and target
# dataset in the same (textured) domain, unlike the geometry version.
...
args.stage1_checkpoint = 'resnet18_scratch_60way_IDEM_colorbg_seed777_model_best.pth.tar'
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_colorbg_from_scratch60way_lr3e-4_seed{args.seed}_'
