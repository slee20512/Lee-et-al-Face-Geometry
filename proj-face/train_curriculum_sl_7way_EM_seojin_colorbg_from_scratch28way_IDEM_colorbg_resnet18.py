...
# fine-tuning on the 7-way emotion colorbg dataset -- same stage-1 backbone as
# train_curriculum_sl_28way_IDEM_from_scratch28way_IDEM_colorbg_resnet18.py but the
# emotion target instead of the identity target.
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_colorbg_from_scratch28way_IDEM_colorbg_seed{args.seed}_'
