...
# Curriculum learning, stage 2 (supervised branch), textured 12-way-identity ver2
# lineage: same structure as train_curriculum_sl_7way_EM_seojin_from_scratch12way_ver2.py,
# but both stage 1 and stage 2 are in the textured domain -- stage 1 is
# train_from_scratch_texture_colorbg_12way_supervised_ver2.py (warmup+cosine+Adam+low
# wd on texture_colorbg_12way), continued here on the textured 7-way emotion set.
# Domain-consistent counterpart to the already-completed SimCLR pair
# (train_simclr_12way_colorbg_scratch.py -> ..._from_simclr12way_colorbg.py).
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_colorbg_from_scratch_texture_colorbg_12way_ver2_seed{args.seed}_'
