...
# Cross-domain curriculum: init from the TEXTURED 12-way identity SimCLR backbone
# (train_simclr_12way_colorbg_scratch.py), continue NT-Xent training on the
# GEOMETRY-only 28-way IDEM dataset (vbsle_50k/28way_IDEM, no colorbg) -- same
# stage-1 backbone as train_curriculum_simclr_7way_EM_seojin_from_simclr12way_colorbg.py,
# different geometry-domain target.
...
args.filename_prefix = f'{args.arch}_curriculum_simclr_28way_IDEM_from_simclr12way_colorbg_seed{args.seed}_'
