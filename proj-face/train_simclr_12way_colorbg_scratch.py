...
# Textured-domain mirror of train_simclr_12way_scratch.py: same setup (random-init
# SimCLR, NT-Xent) but on the textured 12-way identity dataset
# (vbsle_50k_texture_colorbg/texture_colorbg_12way) instead of the geometry-only
# vbsle_50k_12way. Feeds into
# train_curriculum_simclr_7way_EM_seojin_colorbg_from_simclr12way_colorbg.py as stage 2.
...
args.filename_prefix = f'{args.arch}_simclr_texture_colorbg_12way_seed{args.seed}_'
