...
# Curriculum learning, stage 2 (supervised branch), 12-way-identity ImageNet-finetune
# lineage: same structure as train_curriculum_sl_7way_EM_seojin_from_scratch12way.py,
# but the stage-1 checkpoint here is train_finetune_12way_supervised.py
# (ImageNet-pretrained) instead of a random-init backbone -- the from-scratch lineage
# (both lr=0.1 and lr=0.01) never learned past chance level on this dataset.
...
args.stage1_checkpoint = 'resnet50_finetune_vbsle_50k_12way_seed777_model_best.pth.tar'
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_from_finetune12way_seed{args.seed}_'
