...
# ImageNet-pretrained fine-tune ablation of train_from_scratch_28way_combined.py: same
# *combined* 28-way IDEM dataset -- ConcatDataset of the plain vbsle_50k/28way_IDEM set
...
# instead of random init. resnet50 companion to train_finetune_28way_combined_resnet18.py.
...
args.pretrained = True  # start from ImageNet weights, unlike train_from_scratch_28way_combined.py
