...
# ResNet-18 ablation of train_curriculum_sl_7way_EM_seojin.py: same curriculum
# structure (init from the supervised from-scratch 60-way-IDEM backbone, fresh
# 7-class head, SGD, lr 3e-4), but resnet18 instead of resnet50, on top of
# train_from_scratch_60way_resnet18.py's backbone (Acc@1 97.024 on the 60-way task).
...
args.filename_prefix = f'{args.arch}_curriculum_sl_7way_EM_seojin_from_scratch60way_lr3e-4_seed{args.seed}_'
